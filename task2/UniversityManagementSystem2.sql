...
-- UPDATE GRADES
-- SET Feedback = 'Good work, but see me for review.'
-- WHERE 
--     AssignmentID = 1 
--     AND PointsEarned BETWEEN 80 AND 89;


-- UPDATE COURSES
-- SET Description = 'Course is currently under credit review.'
-- WHERE CourseID IN (3, 7);
